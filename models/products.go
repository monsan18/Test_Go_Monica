...
func UpdateProduct(Id_product int, Product_Name string, Price string)(Response,error){ // Fungsi untuk melakukan update dengan method PUT pada tabel author di database iLib
	var res Response 
